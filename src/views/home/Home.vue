<!--
 * @Author: your name
 * @Date: 2021-05-31 16:11:28
 * @LastEditTime: 2021-06-10 15:55:35
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \day7\03-tabbar\src\view\home\Home.vue
-->
<template>
    ...
    methods: {
        ...
        getHomeGoods(type){
            ...
            getHomeGoods(type,page).then((res)=>{
                //console.log(res)
                //把data中的数据塞到goods里 都是数据所以要加...对数组进行解析，一个个取出来push到goods里
